                    ...
                    when (
                        val result =
                            repository.signUp(
                                ...
                                serviceTerms = signUpManager.hasAgreedServiceTerms,
                                privacyPolicies = signUpManager.hasAgreedPrivacyPolicies,
                                communityRules = signUpManager.hasAgreedCommunityRules,
                            )
                    ) {
